...
func getCMDsFlags(getCmd *cobra.Command) {
	...
	getCmd.PersistentFlags().String("stats-polling-interval", "1s", "Interval to poll stats to expose for Prometheus metrics. Valid time units are 'ns', 'us' (or 'µs'), 'ms', 's', 'm', 'h'.")
