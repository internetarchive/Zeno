...
func getCMDsFlags(getCmd *cobra.Command) {
	...
	getCmd.PersistentFlags().StringSlice("domains-crawl", []string{}, "If this is turned on, seeds will be treated as domains to crawl, therefore same-domain outlinks will be added to the queue as hop=0.")
